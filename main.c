...
int main() {
    ...
    printf("\n=== INSTRUÇÕES ===\n");
    printf("1. Instale R: https://www.r-project.org/\n");
    printf("2. Instale pacotes: install.packages(c('ggplot2', 'reshape2'))\n");
    printf("3. Execute: Rscript plot_comparacoes.R\n");
    printf("4. Gráfico gerado: comparacao_estruturas.png\n");
